...
const s = StyleSheet.create({
  ...
  gameCardMeta: { color: "#555", fontSize: 12, marginTop: 3 },
  ...
  joinBannerSub: { color: "#555", fontSize: 12, marginTop: 1 },
  ...
  optionLetterText: { color: "#555", fontSize: 13, fontWeight: "900" },
  ...
  notJoinedNoteText: { color: "#444", fontSize: 13, textAlign: "center" },
  lobbyWaiting: { alignItems: "center", paddingVertical: 32, gap: 10 },
  lobbyWaitingText: { color: "#555", fontSize: 14 },
  finishedBanner: { alignItems: "center", paddingVertical: 24, marginBottom: 8 },
  finishedTitle: { color: "#f59e0b", fontSize: 26, fontWeight: "900" },
  finishedSub: { color: "#555", fontSize: 14, marginTop: 4 },
  section: { marginTop: 8 },
  sectionTitle: { color: "#555", fontSize: 12, fontWeight: "800", letterSpacing: 0.5, textTransform: "uppercase", marginBottom: 10 },
  ...
  participantRank: { color: "#555", fontSize: 14, fontWeight: "900", width: 36, textAlign: "center" },
  participantName: { color: "#fff", fontSize: 14, fontWeight: "800" },
  participantType: { color: "#444", fontSize: 11, marginTop: 1 },
  participantScore: { color: "#06b6d4", fontSize: 16, fontWeight: "900" },
  emptyParticipants: { paddingVertical: 20, alignItems: "center" },
  emptyParticipantsText: { color: "#444", fontSize: 13 },
...
const jm = StyleSheet.create({
  ...
  typeBtnText: { color: "#555", fontWeight: "800", fontSize: 14 },
  typeBtnTextActive: { color: "#06b6d4" },
  teamList: { marginBottom: 16 },
  teamListLabel: { color: "#555", fontSize: 12, fontWeight: "700", marginBottom: 8 },
  noTeamsText: { color: "#444", fontSize: 13, textAlign: "center", paddingVertical: 12 },
  ...
  teamCount: { color: "#555", fontSize: 12 },
