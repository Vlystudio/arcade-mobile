...
const s = StyleSheet.create({
  ...
  gameCard: { backgroundColor: "#111", borderRadius: 18, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: "#1a1a1a" },
  ...
  questionCard: { backgroundColor: "#111", borderRadius: 20, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: "#1a1a1a" },
  ...
  optionsGrid: { gap: 10 },
  optionBtn: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "#0d0d0d", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "#1a1a1a" },
  ...
  textAnswerInput: { backgroundColor: "#0d0d0d", borderRadius: 14, padding: 14, color: "#fff", fontSize: 15, borderWidth: 1, borderColor: "#1a1a1a", minHeight: 80, textAlignVertical: "top" },
...
const jm = StyleSheet.create({
  ...
  sheet: { backgroundColor: "#111", borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingHorizontal: 24, paddingTop: 12, paddingBottom: 40, borderTopWidth: 1, borderColor: "#1a1a1a" },
  ...
  typeBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 14, paddingVertical: 14, borderWidth: 1, borderColor: "#1a1a1a", backgroundColor: "#0d0d0d" },
  ...
  teamRow: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "#0d0d0d", borderRadius: 12, padding: 12, marginBottom: 6, borderWidth: 1, borderColor: "#1a1a1a" },
