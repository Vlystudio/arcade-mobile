...
const g = StyleSheet.create({
  ...
  noticeText: { color: "#444", fontSize: 12 },
...
const gm = StyleSheet.create({
  ...
  stripLabel: { color: "#444", fontSize: 11, marginTop: 2 },
  stripDivider: { width: 1, backgroundColor: "#222" },
  card: { backgroundColor: "#111", borderRadius: 22, padding: 18, marginBottom: 14, borderWidth: 1, borderColor: "#1e1e1e" },
  ...
  lanes: { color: "#444", fontSize: 12 },
  desc: { color: "#555", fontSize: 13, lineHeight: 19, marginBottom: 14 },
  statsRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingTop: 14, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "#1e1e1e" },
  statBlock: { flex: 1 },
  statLabel: { color: "#3a3a3a", fontSize: 10, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 },
...
const lb = StyleSheet.create({
  ...
  gameSelectorPlaceholder: { color: "#444", fontSize: 14 },
  ...
  listRank: { color: "#3a3a3a", fontSize: 13, fontWeight: "800", width: 30, textAlign: "center" },
  ...
  pickerSheet: { backgroundColor: "#111", borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingHorizontal: 20, paddingTop: 16, paddingBottom: 36, borderTopWidth: 1, borderColor: "#1e1e1e", gap: 8 },
...
const fd = StyleSheet.create({
  ...
  locationRow: { flexDirection: "row", marginHorizontal: 18, marginVertical: 12, backgroundColor: "#0d0d0d", borderRadius: 12, padding: 4, borderWidth: 1, borderColor: "#1e1e1e", gap: 4 },
  ...
  locText: { color: "#444", fontSize: 13, fontWeight: "600" },
  ...
  catText: { color: "#555", fontWeight: "600", fontSize: 13 },
  catTextActive: { color: "#000", fontWeight: "800" },
  content: { paddingHorizontal: 18, paddingBottom: 28 },
  itemCard: { flexDirection: "row", alignItems: "center", gap: 14, backgroundColor: "#111", borderRadius: 18, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: "#1e1e1e" },
  ...
  itemDesc: { color: "#444", fontSize: 12, lineHeight: 17, marginBottom: 5 },
  ...
  cartSheet: { backgroundColor: "#111", borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 24, paddingBottom: 36, borderTopWidth: 1, borderColor: "#1e1e1e", gap: 10 },
  ...
  cartEmptyText: { color: "#444", fontSize: 14 },
  cartRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "#1e1e1e" },
  cartRowEmoji: { fontSize: 24 },
  cartRowName: { color: "#fff", fontWeight: "700", fontSize: 14 },
  cartRowPrice: { color: "#444", fontSize: 12, marginTop: 2 },
  ...
  cartCancelText: { color: "#555", fontWeight: "700", fontSize: 14 },
});
...
const tm = StyleSheet.create({
  ...
  sectionLabel: { color: "#3a3a3a", fontSize: 10, fontWeight: "800", textTransform: "uppercase", letterSpacing: 1.4, marginBottom: 12 },
  card: { flexDirection: "row", alignItems: "center", gap: 14, backgroundColor: "#111", borderRadius: 20, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: "#1e1e1e" },
  ...
  teamMeta: { color: "#444", fontSize: 12 },
  teamAvg: { fontSize: 20, fontWeight: "900" },
  teamAvgLabel: { color: "#444", fontSize: 11 },
...
const ad = StyleSheet.create({
  ...
  tabLabel: { color: "#444", fontSize: 13, fontWeight: "700" },
  ...
  subTabText: { color: "#444", fontSize: 12, fontWeight: "700" },
  subTabTextActive: { color: "#06b6d4" },
  empty: { alignItems: "center", paddingTop: 60, gap: 12 },
  emptyTitle: { color: "#fff", fontSize: 20, fontWeight: "900" },
  emptySub: { color: "#444", fontSize: 14 },
  card: { backgroundColor: "#111", borderRadius: 18, borderWidth: 1, borderColor: "#1e1e1e", marginBottom: 12, overflow: "hidden" },
  ...
  healthCard: { flex: 1, backgroundColor: "#111", borderRadius: 16, padding: 16, alignItems: "center", gap: 4, borderWidth: 1, borderColor: "#1e1e1e" },
  healthValue: { fontSize: 26, fontWeight: "900" },
  healthLabel: { color: "#444", fontSize: 10, fontWeight: "700", textAlign: "center" },
});
...
const pr = StyleSheet.create({
  ...
  heroEmail: { color: "#3a3a3a", fontSize: 13, marginTop: 2 },
  ...
  statBox: { flex: 1, backgroundColor: "#111", borderRadius: 18, padding: 16, alignItems: "center", gap: 4, borderWidth: 1, borderColor: "#1e1e1e" },
  statValue: { fontSize: 28, fontWeight: "900" },
  statLabel: { color: "#444", fontSize: 11 },
  ...
  scoresCard: { backgroundColor: "#111", borderRadius: 18, borderWidth: 1, borderColor: "#1e1e1e", overflow: "hidden", marginBottom: 28 },
  ...
  scoreTime: { color: "#444", fontSize: 11, marginTop: 2 },
  ...
  actionsCard: { backgroundColor: "#111", borderRadius: 18, borderWidth: 1, borderColor: "#1e1e1e", overflow: "hidden", marginBottom: 16 },
